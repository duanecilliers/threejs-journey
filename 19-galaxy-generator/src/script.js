...
const generateGalaxy = () => {
    ...
    material = new THREE.PointsMaterial({
        ...
        vertexColors: true
        // blending: THREE.AdditiveBlending.toExponential,
        // color: '#ff5599'
    })
...
gui.add(parameters, 'radius', 0.001, 20, 0.001).onFinishChange(generateGalaxy)
...
gui.add(parameters, 'randomnessPow', 1, 10, 0.001).onFinishChange(generateGalaxy)
